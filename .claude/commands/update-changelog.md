...
```yaml
# Describes the workflow for automating CHANGELOG.md generation.
changelog_automation_workflow:
  ...
  # Defines the sequence of operations for the workflow.
  execution_flow:
    # Handles how the process starts based on input.
    ...
    # Ensures the changelog file exists and is properly formatted.
    ...
    # Gathers and formats the changelog content.
