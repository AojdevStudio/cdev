...
describe('SimpleInstaller', () => {
  ...
  describe('install', () => {
    ...
    test('completes full installation successfully', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(expect.stringContaining('Successfully installed cdev files'));
  ...
  describe('createBasicHookScripts', () => {
    test('creates pre-bash-validator with dangerous patterns', async () => {
      ...
      const preBashCall = fs.writeFile.mock.calls.find(
        call => call[0].includes('pre-bash-validator.py')
      );
    ...
    test('creates typescript-validator with any type check', async () => {
      ...
      const tsCall = fs.writeFile.mock.calls.find(
        call => call[0].includes('typescript-validator.py')
      );
    ...
    test('creates notification hook with platform detection', async () => {
      ...
      const notificationCall = fs.writeFile.mock.calls.find(
        call => call[0].includes('notification.py')
      );
    ...
    test('creates task-completion-enforcer with TODO/FIXME detection', async () => {
      ...
      const taskCall = fs.writeFile.mock.calls.find(
        call => call[0].includes('task-completion-enforcer.py')
      );
  ...
  describe('copyCommandTemplates', () => {
    test('creates agent-start command', async () => {
      ...
      const agentStartCall = fs.writeFile.mock.calls.find(
        call => call[0].includes('agent-start.sh')
      );
    ...
    test('creates agent-commit command', async () => {
      ...
      const agentCommitCall = fs.writeFile.mock.calls.find(
        call => call[0].includes('agent-commit.sh')
      );
    ...
    test('creates agent-status command', async () => {
      ...
      const agentStatusCall = fs.writeFile.mock.calls.find(
        call => call[0].includes('agent-status.sh')
      );
  ...
  describe('createExampleConfig', () => {
    test('creates .env.example file', async () => {
      ...
      const envCall = fs.writeFile.mock.calls.find(
    ...
    test('creates CLAUDE.md file', async () => {
      ...
      const claudeMdCall = fs.writeFile.mock.calls.find(
        call => call[0].includes('CLAUDE.md')
      );
