...
describe('Prepublish Script Tests', () => {
  ...
  beforeEach(() => {
    ...
    jest.doMock(path.join(mockProjectRoot, 'package.json'), () => mockPackageJson, {
      virtual: true,
    });
  });
  ...
  describe('validatePackageJson', () => {
    ...
    test('should throw error if required fields are missing', () => {
      ...
      jest.doMock(path.join(mockProjectRoot, 'package.json'), () => incompletePackage, {
        virtual: true,
      });
    ...
    test('should throw error for invalid version format', () => {
      ...
      jest.doMock(path.join(mockProjectRoot, 'package.json'), () => invalidVersionPackage, {
        virtual: true,
      });
  ...
  describe('validateRequiredFiles', () => {
    ...
    test('should identify specific missing files', () => {
      fs.existsSync.mockImplementation((filePath) => !filePath.includes('README.md'));
