...
describe('IntelligentAgentGenerator', () => {
  ...
  describe('analyzeRequirement', () => {
    ...
    test('estimates complexity correctly', () => {
      ...
      const complexReq =
        'Build scalable microservices architecture with security integration and performance optimization';
  ...
  describe('extractActions', () => {
    test('extracts all action verbs', () => {
      const requirement =
        'Create, build, implement, fix, enhance, integrate, configure, and test the system';
  ...
  describe('estimateComplexity', () => {
    ...
    test('returns high complexity for complex requirements', () => {
      const requirement =
        'Implement secure authentication system with JWT tokens, integrate with multiple OAuth providers, ensure scalability and performance optimization, add comprehensive security measures';
      const complexity = generator.estimateComplexity(requirement);
  ...
  describe('generateAgentForRequirement', () => {
    ...
    test('handles complex multi-domain requirements', () => {
      const requirement =
        'Implement full-stack feature with React frontend, Node.js API, MongoDB integration, and comprehensive testing';
      const agent = generator.generateAgentForRequirement(requirement);
