...
describe('Postpublish Script Tests', () => {
  ...
  describe('cleanupTemporaryFiles', () => {
    test('should clean up existing temporary files', () => {
      ...
      expect(fs.unlinkSync).toHaveBeenCalledWith(expect.stringContaining('dist-manifest.json'));
      expect(fs.unlinkSync).toHaveBeenCalledWith(expect.stringContaining('npm-debug.log'));
    });
